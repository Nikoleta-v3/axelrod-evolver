...
def evolve(starting_tables, mutation_rate, generations, bottleneck, pool, plys, start_plys, starting_pop, output_file):
    ...
    for generation in range(generations):
        ...
        with open(output_file, "a") as output:
            ...
            results = spatial_binomial_utils.score_tables_min_binomial(population, pool)
...
if __name__ == '__main__':
    ...
    # set the output file
    output_file = '/scratch/c1569433/data/binomial_min_evolve.csv'
    ...
    if not file_exists:
        ...
        real_starting_tables = spatial_binomial_utils.score_tables_min_binomial(starting_tables, pool)
