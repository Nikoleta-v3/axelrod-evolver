...
from spatial_scripts import spatial_small_utils
...
def evolve(starting_tables, mutation_rate, generations, bottleneck, pool, plys, start_plys, starting_pop, output_file):
    ...
    for generation in range(generations):
        ...
        with open(output_file, "a") as output:
            ...
            results = spatial_small_utils.score_tables_median_small(population, pool)
            ...
            for value in [generation, spatial_small_utils.id_for_table(results[0][1]), results[0][0], spatial_small_utils.mean(scores), spatial_small_utils.pstdev(scores)]:
...
if __name__ == '__main__':
    ...
    # set the output file
    output_file = '/scratch/c1569433/data/small_median_evolve.csv'
    ...
    if not file_exists:
        ...
        real_starting_tables = spatial_small_utils.score_tables_median_small(starting_tables, pool)
