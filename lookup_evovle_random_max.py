...
def evolve(starting_tables, mutation_rate, generations, bottleneck, pool, plys, start_plys, starting_pop, output_file):
    ...
    for generation in range(generations):
        ...
        with open(output_file, "a") as output:
            ...
            results = spatial_random_utils.score_tables_max_random(population, pool)
...
if __name__ == '__main__':
    ...
    # set the output file
    output_file = 'random_max_evolve.csv'
    ...
    if not file_exists:
        ...
        real_starting_tables = spatial_random_utils.score_tables_max_random(starting_tables, pool)
